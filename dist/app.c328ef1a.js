...
// ajax  사용시작
var ajax = new XMLHttpRequest(); // 바뀔 데이터주소같은경우는 변수로 만들어서 쓰는게 좋다

var NEWS_URL = "https://api.hnpwa.com/v0/news/1.json"; // .ajax.open() api 주소를 받아오는법 (method,url,true or false(비동기 or 동기))
...
ajax.send();
console.log(ajax.response); // json 형식의 문자열을 자바스크립트 객체로 바꿔줌

console.log(JSON.parse(ajax.response)); // newsFeed의 정보
